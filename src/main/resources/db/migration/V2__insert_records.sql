...
INSERT INTO courses (title, description, price, language, level, duration, user_id) VALUES
                                                                              ('English for Beginners', 'Basic English course focused on daily vocabulary.', 29.99, 'English', 'Beginner', 40, 1),
                                                                              ...
                                                                              ('Japanese Hiragana', 'Learn Japanese writing system.', 27.99, 'Japanese', 'Beginner', 42, 7),
                                                                              ('Japanese Vocabulary Boost', 'Improve your Japanese words and expressions.', 31.99, 'Japanese', 'Intermediate', 48, 7),
                                                                              ...
                                                                              ('Arabic Alphabet 1', 'Learn Arabic script.', 22.99, 'Arabic', 'Beginner', 30, 21),
                                                                              ('Arabic Vocabulary', 'Expand your Arabic vocabulary.', 29.99, 'Arabic', 'Intermediate', 40, 21),
                                                                              ...
                                                                              ('Japanese Basics', 'Learn Japanese alphabet & essentials.', 16.99, 'Japanese', 'Beginner', 25, 30),
                                                                              ('Japanese Conversation', 'Improve spoken Japanese.', 25.99, 'Japanese', 'Intermediate', 40, 30);
